...
mut_info <- (readRDS('./Four_omics_data/driver_SNV_hg38.RDS'))
#cnv_info <- (readRDS('./Four_omics_data/cnv_info.RDS'))
cnv_info <- (readRDS('./Four_omics_data/cnv_info_hg38.RDS'))
meth_info <- (readRDS('./Four_omics_data/meth_info.RDS'))
#RNA_info <- (readRDS('./Four_omics_data/rna_info.RDS'))
RNA_info <- (readRDS('./Four_omics_data/rna_info_hg38.RDS'))
...
dim(net_combine_unique)
### Store the combined network
#write.table(net_combine_unique,'net_combine_unique_hg38.txt',
