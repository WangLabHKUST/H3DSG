...
graphics.off()
pdf('Methy_cluster_add_annotation.pdf',width=8,height = 12)
...
graphics.off()
pdf('CNV_cluster_add_annotation.pdf',
    width=8,height = 10)
...
graphics.off()
pdf('RNA_cluster_add_annotation.pdf',
    width=8,height = 10)
...
graphics.off()
pdf('Mutation_cluster_add_annotation.pdf',
    width=8,height = 6)
...
rownames(group)<- group$Row.names
group <- group[,-1]
used_info <- as.data.frame(info[,c(2:6,8:9)])
